...
const label = require('./label-980508de.js');
const form = require('./form-0ef859c8.js');
...
const Switch = class {
  ...
  // --------------------------------------------------------------------------
  render() {
    return (index.h(index.Host, { onKeyDown: this.keyDownHandler }, index.h("div", { "aria-checked": this.checked.toString(), "aria-label": label.getLabelText(this), class: "container", onClick: this.clickHandler, ref: this.setSwitchEl, role: "switch", tabIndex: 0 }, index.h("div", { class: "track" }, index.h("div", { class: "handle" })), index.h(form.HiddenFormInputSlot, { component: this }))));
  }
